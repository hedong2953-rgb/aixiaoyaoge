const toolsData = [
  {
    ...
    detail: {
      intro: "ChatGPT 是 OpenAI 开发的先进人工智能对话系统，基于 GPT-4 系列模型，能够进行自然流畅的对话，帮助用户完成写作、编程、翻译、分析等多种任务。",
      features: ["支持文本对话、图像识别、文件分析","可联网搜索（需手动开启）","支持自定义GPTs","代码解释器功能强大"],
  ...
  },
  {
    ...
    url: "https://claude.ai",
    detail: {
      intro: "Claude 由 Anthropic 公司开发，以安全性和长文本处理能力著称。Claude 3.5 Sonnet 在多项基准测试中表现优异。",
      features: ["超长上下文（200K tokens）","安全性设计领先","支持文件上传分析","编程和数学推理能力强"],
  ...
  },
  {
    ...
    detail: {
      intro: "DeepSeek（深度求索）是中国顶级AI公司推出的对话模型，在编程和数学推理方面表现极为出色，性价比极高。",
      features: ["强大的编程和推理能力","百万级上下文窗口","支持联网搜索","完全免费"],
      pricing: "完全免费",
      tags: ["对话","编程","推理","国产"]
    }
  },
  {
    ...
    detail: {
      intro: "通义千问是阿里巴巴推出的AI大模型，集成了对话、文档处理、图像理解等多种能力。",
  ...
  },
  {
    ...
    detail: {
      intro: "豆包是字节跳动推出的AI对话助手，集成了文本对话、图像理解、语音交互等多种功能，与字节生态深度整合。",
  ...
  },
  {
    ...
    detail: {
      intro: "Kimi 由月之暗面（Moonshot AI）开发，超长文本处理能力出色，特别适合分析长篇文档和论文。",
      features: ["超长文本处理（百万字级别）","文件分析功能强大","联网搜索","国产免费"],
      pricing: "免费",
      tags: ["对话","长文本","国产","分析"]
    }
  },
  ...
  },
  {
    ...
    detail: {
      intro: "Perplexity 是一款AI驱动搜索引擎，与传统搜索不同，它直接给出答案并附上信息来源。",
      features: ["答案附带引用来源","支持深度搜索","Pro版可切换多种模型","文件分析功能"],
      pricing: "免费版可用；Pro版$20/月",
      tags: ["搜索","调研","信息","引用"]
    }
  },
  {
    ...
    url: "https://grok.com",
    detail: {
      intro: "Grok 是 xAI（Elon Musk 创立）推出的AI对话助手，以实时信息获取和幽默风格著称，深度整合X平台数据。",
  ...
  },
  {
    ...
    detail: {
      intro: "Midjourney 是目前最受欢迎的AI绘画工具之一，以其独特的艺术风格和高质量图像生成能力闻名。",
      features: ["艺术风格独特，质感出色","支持多种风格和比例","图生图、混合模式","社区活跃，灵感丰富"],
  ...
  },
  {
    ...
    detail: {
      intro: "Stable Diffusion 是 Stability AI 推出的开源文本到图像生成模型，可在本地部署运行，完全免费且私密。",
      features: ["完全开源，可本地部署","庞大的插件和模型生态","支持ControlNet等高级控制","免费使用"],
      pricing: "开源免费；在线版有免费额度",
      tags: ["绘画","开源","本地部署","免费"]
    }
  },
  {
    ...
    detail: {
      intro: "DALL·E 3 是 OpenAI 最新的图像生成模型，集成在 ChatGPT 中，通过自然语言描述即可生成高质量图像。",
      features: ["集成ChatGPT，对话式生成","文字渲染能力强","图像质量和安全性高","支持图像编辑"],
  ...
  },
  {
    ...
    desc: "AI音乐生成，输入歌词即可生成完整歌曲",
    url: "https://suno.com",
    detail: {
      intro: "Suno 是当前最热门的AI音乐生成工具，只需输入歌词即可生成带人声和伴奏的完整歌曲，支持多种风格。",
      features: ["从歌词生成完整歌曲","支持多种音乐风格","V4版本音质大幅提升","支持中文歌词"],
  ...
  },
  {
    ...
    detail: {
      intro: "Udio 是一款高品质AI音乐生成工具，以出色的音质和丰富的风格选项受到音乐爱好者的青睐。",
      features: ["音质细腻，堪比真人","支持多种音乐风格","可自定义歌词和风格","支持歌曲续写"],
  ...
  },
  {
    ...
    detail: {
      intro: "Cursor 是一款基于 VS Code 的AI代码编辑器，内置强大的AI辅助编程功能，支持多模型切换。",
      features: ["基于VS Code，兼容插件生态","支持多模型（Claude/GPT-4）","代码库级上下文理解","Tab补全、内联编辑"],
  ...
  },
  {
    ...
    detail: {
      intro: "GitHub Copilot 是GitHub和OpenAI联合推出的AI编程助手，深度集成在VS Code、JetBrains等主流IDE中。",
      features: ["实时代码补全","支持多种编程语言","Copilot Chat交互式编程","深度整合GitHub生态"],
      pricing: "免费版2000次补全/月；Pro版$10/月",
      tags: ["编程","补全","效率","开发"]
    }
  },
  {
    ...
    detail: {
      intro: "Windsurf 是 Codeium 推出的AI原生IDE，结合了IDE的强大功能和AI的智能辅助。",
      features: ["AI原生IDE体验","深度代码理解和推理","多文件编辑","自动补全和错误检测"],
  ...
  },
  {
    ...
    detail: {
      ...
      features: ["高质量文生视频","视频转视频风格迁移","绿幕去除、运动跟踪","专业级AI视频编辑"],
  ...
  },
  {
    ...
    url: "https://pika.art",
    detail: {
      intro: "Pika 是一款用户友好的AI视频生成工具，以简单易用著称，支持文本和图像生成视频。",
      features: ["操作简单，上手快","支持文生视频和图生视频","视频编辑和局部修改","社区展示作品"],
  ...
  },
  {
    ...
    detail: {
      intro: "HuggingFace 是全球最大的AI模型托管和社区平台，提供数以万计的开源模型、数据集，还能在线试用各种AI模型。",
      features: ["海量开源模型和数据集","在线模型试用","Spaces应用托管","活跃的AI开发者社区"],
      pricing: "免费",
      tags: ["社区","模型","开源","数据集"]
    }
  },
  ...
  },
  {
    ...
    url: "https://gamma.app",
    detail: {
      intro: "Gamma 是一款AI驱动的演示文稿工具，只需输入主题，AI即可在几秒内生成精美PPT或文档。",
  ...
  },
  {
    ...
    detail: {
      ...
      features: ["高质量的文生视频","逼真的物理世界模拟","长达60秒的视频生成","丰富的镜头语言"],
  ...
  },
  {
    ...
    detail: {
      intro: "Coze（扣子）是字节跳动推出的AI Bot开发平台，用户无需编程即可创建定制化的AI助手。",
